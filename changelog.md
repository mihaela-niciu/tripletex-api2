...
- Deprecated `GET /project/resourcePlanBudget` in favor of `GET /project/capacityPlan/budget`.
  - The new endpoint is identical except the response field `hoursEntries` has been renamed to `hourEntries`.
